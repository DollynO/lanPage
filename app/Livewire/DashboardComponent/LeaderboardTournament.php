...
class LeaderboardTournament extends Component
{
    ...
    public function render()
    {
        ...
        foreach ($tournament_rounds as $round) {
            foreach ($round->results()->get() as $round_results) {
        ...
        return view('livewire.dashboard-component.leaderboard-tournament', [
    ...
    {
        $this->dispatch('leaveLeaderboardView');
    }
}
