...
$classes = Flux::classes()
    ...
    ->add(match ($variant) { // Background color...
        ...
        'fi-btn' => 'fi-color fi-color-primary fi-bg-color-400 hover:fi-bg-color-300 dark:fi-bg-color-600 dark:hover:fi-bg-color-500 fi-text-color-800 hover:fi-text-color-800 dark:fi-text-color-950 dark:hover:fi-text-color-900 fi-btn fi-size-md  fi-ac-btn-action neon-button-primary',
